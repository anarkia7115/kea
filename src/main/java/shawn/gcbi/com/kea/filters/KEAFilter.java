package shawn.gcbi.com.kea.filters;
...
import shawn.gcbi.com.kea.stemmers.SpanishStemmerSB;
import shawn.gcbi.com.kea.stemmers.SremovalStemmer;
import shawn.gcbi.com.kea.stemmers.Stemmer;
import shawn.gcbi.com.kea.stopwords.Stopwords;
import shawn.gcbi.com.kea.stopwords.StopwordsEnglish;
import shawn.gcbi.com.kea.stopwords.StopwordsSpanish;
import shawn.gcbi.com.kea.util.Counter;
import shawn.gcbi.com.kea.vocab.Vocabulary;
...
public class KEAFilter extends Filter implements OptionHandler {
	...
	private void buildClassifier() throws Exception {
		...
		m_Classifier = rvd;
		m_Classifier.getCapabilities().enable(Capability.MISSING_VALUES);
	...
	throws Exception {
		...
		*/
		...
		while (it.hasNext()) {
			...
			// If simple Naive Bayes used, change here to probs[1]
			// double prob = probs[1];
			double prob = probs[0];
		    // System.out.println("Prob for " + id + " = " + probs[0] + " , " + probs[1]);
