package shawn.gcbi.com.kea;
import shawn.gcbi.com.kea.main.KEAKeyphraseExtractor;
import shawn.gcbi.com.kea.main.KEAModelBuilder;
import shawn.gcbi.com.kea.stemmers.*;
import shawn.gcbi.com.kea.stopwords.*;
...
public class TestKea {
	...
	private void setOptionsTraining() {
		...
		km.setVocabulary("piet");
		
		km.setUseKFrequency(true);
		// km.setDebug(true);
...
//		 B. optional arguments if you want to change the defaults
		...
		km.setDocumentLanguage("da"); // es for Spanish, fr for French
...
//		 B. optional arguments if you want to change the defaults
	...
	public static void main(String[] args) {
		...
		String m_testdir = "/home/olena/etienne/test";
